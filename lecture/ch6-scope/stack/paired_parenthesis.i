...
# 2 "paired_parenthesis.c" 2
# 1 "/usr/include/err.h" 1 3 4
# 69 "/usr/include/err.h" 3 4
...
# 70 "/usr/include/err.h" 2 3 4
# 1 "/usr/include/Availability.h" 1 3 4
# 172 "/usr/include/Availability.h" 3 4
# 1 "/usr/include/AvailabilityInternal.h" 1 3 4
# 173 "/usr/include/Availability.h" 2 3 4
# 71 "/usr/include/err.h" 2 3 4


void err(int, const char *, ...) __attribute__((noreturn)) __attribute__((__format__ (__printf__, 2, 3)));
void verr(int, const char *, __darwin_va_list) __attribute__((noreturn)) __attribute__((__format__ (__printf__, 2, 0)));
void errc(int, int, const char *, ...) __attribute__((noreturn)) __attribute__((__format__ (__printf__, 3, 4)));
void verrc(int, int, const char *, __darwin_va_list) __attribute__((noreturn)) __attribute__((__format__ (__printf__, 3, 0)));
void errx(int, const char *, ...) __attribute__((noreturn)) __attribute__((__format__ (__printf__, 2, 3)));
void verrx(int, const char *, __darwin_va_list) __attribute__((noreturn)) __attribute__((__format__ (__printf__, 2, 0)));
...
# 6 "paired_parenthesis.c" 2




# 9 "paired_parenthesis.c"
void make_empty(void);
void push(int i);
int pop(void);

# 12 "paired_parenthesis.c" 3 4
_Bool 
# 12 "paired_parenthesis.c"
    is_empty(void);

# 13 "paired_parenthesis.c" 3 4
_Bool 
# 13 "paired_parenthesis.c"
    is_full(void);



# 16 "paired_parenthesis.c" 3 4
_Bool

# 17 "paired_parenthesis.c"
...
# 22 "paired_parenthesis.c" 3 4
   (__builtin_expect(!(
# 22 "paired_parenthesis.c"
   a[i] == '(' || a[i] == ')'
# 22 "paired_parenthesis.c" 3 4
   ), 0) ? __assert_rtn(__func__, "paired_parenthesis.c", 22, 
# 22 "paired_parenthesis.c"
   "a[i] == '(' || a[i] == ')'"
# 22 "paired_parenthesis.c" 3 4
   ) : (void)0)
...
# 34 "paired_parenthesis.c" 3 4
_Bool

# 35 "paired_parenthesis.c"
...
# 62 "paired_parenthesis.c" 3 4
 (__builtin_expect(!(
# 62 "paired_parenthesis.c"
 paired_parentheses(a, sz)
# 62 "paired_parenthesis.c" 3 4
 ), 0) ? __assert_rtn(__func__, "paired_parenthesis.c", 62, 
# 62 "paired_parenthesis.c"
 "paired_parentheses(a, sz)"
# 62 "paired_parenthesis.c" 3 4
 ) : (void)0)
...
# 63 "paired_parenthesis.c" 3 4
 (__builtin_expect(!(
# 63 "paired_parenthesis.c"
 paired_parentheses_switch(a, sz)
# 63 "paired_parenthesis.c" 3 4
 ), 0) ? __assert_rtn(__func__, "paired_parenthesis.c", 63, 
# 63 "paired_parenthesis.c"
 "paired_parentheses_switch(a, sz)"
# 63 "paired_parenthesis.c" 3 4
 ) : (void)0)
